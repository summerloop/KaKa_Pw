...
#define kVRGCalendarViewTopBarHeight 60   //weekday的标题高度
#define kVRGCalendarViewWidth [UIScreen mainScreen].bounds.size.width //日记背景视图的宽度

#define kVRGCalendarViewDayWidth ([UIScreen mainScreen].bounds.size.width-10)/7.0 //每一个格子的宽度
#define kVRGCalendarViewDayHeight 44   //每一个格子的高度
